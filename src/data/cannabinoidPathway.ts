...
export const cannabinoidPathway: PathwayGraph = {
  ...
  nodes: [
    ...
    { id: 'm2', type: 'molecule', data: { name: 'Olivetolic acid (OA)', smiles: 'OC(=O)c1c(O)cc(O)cc1CCCCC' } },
    { id: 'm3', type: 'molecule', data: { name: 'Cannabigerolic acid (CBGA)', smiles: 'OC(=O)c1c(O)c(CC=C(C)CCC=C(C)C)c(O)cc1CCCCC' } },
